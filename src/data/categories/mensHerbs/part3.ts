...
export const mensHerbsPart3: Herb[] = [
  ...
  },
  {
    ...
    name: 'Saw Palmetto Plus',
    color: '#8D6E63',
    benefits: [
      'Enhanced formula for prostate health',
      'Contains saw palmetto with supporting herbs',
      'Comprehensive support for male reproductive system',
  ...
  },
  {
    ...
    benefits: [
      ...
      'Traditional herb for overall wellness and energy',
      'Supports vascular health important for male function'
    ],
  ...
  },
  {
    ...
    color: '#D7CCC8',
    benefits: [
      'Traditional Chinese herb for overall vitality and immunity',
  ...
  },
  {
    ...
    color: '#8D6E63',
    benefits: [
      'Adaptogen that supports energy and endurance',
      'May help with physical and mental performance',
  ...
  },
  {
    ...
    name: 'Cordyceps & Reishi Blend',
    color: '#795548',
    benefits: [
      'Synergistic mushroom blend for male vitality',
      'Combines energy support with stress modulation',
      'Traditional Asian blend for wellness and stamina',
  ...
  },
  {
    ...
    color: '#3E2723',
    benefits: [
      'Specific maca variety for male reproductive health',
      'More concentrated in compounds supporting male vitality',
      'Traditional Andean herb for energy and stamina',
