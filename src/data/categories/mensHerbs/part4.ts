...
export const mensHerbsPart4: Herb[] = [
  {
    ...
    color: '#81C784',
    benefits: [
      'Balancing adaptogen for hormone health',
  ...
  },
  {
    ...
    color: '#BA68C8',
    benefits: [
      'Adaptogen that supports energy and mental function',
      'May help with physical performance and stamina',
  ...
  },
  {
    ...
    color: '#5D4037',
    benefits: [
      'Traditional African herb for male vitality',
      'Supports healthy circulation to reproductive organs',
      'Contains yohimbine that supports male function',
  ...
  },
  {
    ...
    color: '#D32F2F',
    benefits: [
      'Adaptogen that supports liver and kidney function',
      'May help with energy and endurance',
  ...
  },
  {
    ...
    color: '#9575CD',
    benefits: [
      'Contains natural L-DOPA for dopamine support',
      'May help with mood and motivation',
  ...
  {
    id: 'tongkat-ali-plus',
    name: 'Tongkat Ali Plus',
    color: '#6D4C41',
    benefits: [
      'Enhanced formula for male vitality',
      'Contains concentrated tongkat ali with supporting herbs',
      'Comprehensive support for male reproductive health',
  ...
  },
  {
    ...
    color: '#8BC34A',
    benefits: [
      'Nutrient-dense superfood for overall vitality',
  ...
  },
  {
    ...
    color: '#A1887F',
    benefits: [
      'Premium Asian ginseng for male vitality',
      'Supports energy, stamina and endurance',
      'Traditional herb for overall wellness',
  ...
  },
  {
    ...
    color: '#BCAAA4',
    benefits: [
      'More cooling than Asian ginseng',
      'Supports balanced energy without overstimulation',
      'Traditional Native American herb for vitality',
