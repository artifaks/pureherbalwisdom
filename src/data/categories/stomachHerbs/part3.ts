...
export const stomachHerbsPart3: Herb[] = [
  {
    id: 'coriander-seed',
    name: 'Coriander Seed',
    color: '#FFCA28',
  ...
  },
  {
    ...
    color: '#A1887F',
    benefits: [
      'Warming digestive aid that improves metabolism',
      'May help with digestive discomfort and bloating',
      'Traditional carminative in many cultures',
  ...
  },
  {
    ...
    color: '#8BC34A',
    benefits: [
      'Aromatic digestive aid that enhances other herbs',
      'Helps with gas, bloating and digestive spasms',
      'Traditional remedy for bad breath from digestion',
  ...
  },
  {
    ...
    benefits: [
      ...
      'Supports healthy metabolism of foods',
      'May help with digestive inflammation'
    ],
  ...
  },
  {
    ...
    color: '#FFD54F',
    benefits: [
      'Carminative that helps relieve gas and bloating',
      'Traditional digestive aid for heavy meals',
      'May help with digestive spasms and colic',
  ...
  },
  {
    ...
    color: '#AED581',
    benefits: [
      'Gentle carminative safe for all ages',
      'Traditionally used for infant colic',
      'Helps with gas, bloating and digestive spasms',
  ...
  },
  {
    ...
    color: '#9CCC65',
    benefits: [
      'Powerful herbal laxative for occasional constipation',
      'Stimulates intestinal movement',
      'Traditionally used for cleansing protocols',
