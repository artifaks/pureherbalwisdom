...
export const stomachHerbsPart4: Herb[] = [
  {
    id: 'slippery-elm-enhanced',
    name: 'Slippery Elm Enhanced',
    color: '#FFAB91',
    benefits: [
      'Advanced formula for digestive healing',
      'Contains concentrated mucilage for gut lining support',
      'Enhanced with marshmallow for synergistic effects',
  ...
  },
  {
    ...
    color: '#FFC107',
    benefits: [
      'Deglycyrrhizinated licorice for safe long-term use',
      'Supports healing of stomach and intestinal lining',
  ...
  },
  {
    ...
    color: '#FF9800',
    benefits: [
      'Synergistic digestive and anti-inflammatory blend',
      'Supports healthy digestive function and comfort',
  ...
  },
  {
    ...
    color: '#81C784',
    benefits: [
      'Enhanced aloe formula for digestive healing',
      'Contains aloe vera with supporting herbs',
      'Supports healthy gut lining and function',
  ...
  },
  {
    ...
    color: '#8D6E63',
    benefits: [
      'Traditional European digestive bitter blend',
      'Stimulates digestive secretions and function',
      'Contains multiple bitter herbs for complete support',
  ...
  },
  {
    ...
    name: 'Marshmallow & Slippery Elm',
    color: '#E1BEE7',
    benefits: [
      'Powerful demulcent blend for digestive healing',
      'Soothes and protects irritated digestive tissues',
      'Supports recovery from digestive inflammation',
  ...
  },
  {
    ...
    name: 'Peppermint-Fennel Blend',
    color: '#4CAF50',
    benefits: [
      'Synergistic carminative for gas and bloating',
      'Combines cooling and warming digestive herbs',
      'Supports healthy digestion and comfort',
  ...
  },
  {
    ...
    color: '#8D6E63',
    benefits: [
      'Enhanced Ayurvedic digestive formula',
      'Contains traditional triphala with supporting herbs',
  ...
  },
  {
    ...
    name: 'Digestive Chai Blend',
    color: '#A1887F',
    benefits: [
      'Warming spice blend for digestive support',
      'Combines traditional digestive spices from Ayurveda',
      'Supports metabolism and digestive comfort',
  ...
  },
  {
    ...
    name: 'Chamomile-Lavender Blend',
    color: '#FFD54F',
    benefits: [
      'Calming blend for nervous digestion',
      'Supports healthy digestive function during stress',
      'Soothes digestive discomfort and tension',
